...
![Example namespace](https://cdn.rawgit.com/vanadium/docs/images/namespace-generic.svg)
...
![The view from Client 1](https://cdn.rawgit.com/vanadium/docs/images/namespace-client1.svg)

In contrast, process `Client 2` with `ns2.v.io:8102` as its root can
resolve only `y` and `z`.

![The view from Client 2](https://cdn.rawgit.com/vanadium/docs/images/namespace-client2.svg)
...
![The leaves are servers, or empty tables](https://cdn.rawgit.com/vanadium/docs/images/namespace-with-servers.svg)
